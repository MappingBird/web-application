...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.thumb_path'
        db.add_column(u'bucketlist_image', 'thumb_path',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.thumb_path'
        db.delete_column(u'bucketlist_image', 'thumb_path')
    ...
    models = {
        ...
        u'bucketlist.image': {
            ...
            'thumb_path': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
