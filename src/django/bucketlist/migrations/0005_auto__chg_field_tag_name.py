...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bucketlist_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Tag.name'
        db.alter_column(u'bucketlist_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
