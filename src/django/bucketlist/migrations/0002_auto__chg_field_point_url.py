...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Point.url'
        db.alter_column(u'bucketlist_point', 'url', self.gf('django.db.models.fields.URLField')(max_length=4096))

    def backwards(self, orm):

        # Changing field 'Point.url'
        db.alter_column(u'bucketlist_point', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
